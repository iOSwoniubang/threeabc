...
- (id)initWithFrame:(CGRect)frame cropHeight_width_scale:(float)height_weight_scale;
{
    ...
    if (self) {
        ...
        self.cropRectView = [[PECropRectView alloc] initWithFrame:CGRectZero cropHeight_width_scale:_height_width_scale];
...
- (void)layoutCropRectViewWithCropRect:(CGRect)cropRect
{
    ...
    cropRect=CGRectMake(cropRect.origin.x, cropRect.origin.y, cropRect.size.width, _height_width_scale*(cropRect.size.width));
    else
